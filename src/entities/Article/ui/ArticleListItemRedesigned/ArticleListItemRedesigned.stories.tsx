...
export default {
    title: 'entities/ArticleListItemRedesigned',
...
export const NormalCardDark = Template.bind({})
NormalCardDark.args = {
    article,
    view: ArticleView.CARDS,
}
NormalCardDark.decorators = [ThemeDecorator(Theme.DARK)]

export const NormalListLoading = Template.bind({})
NormalListLoading.args = {
    article,
    view: ArticleView.LIST,
}

export const NormalCardLoading = Template.bind({})
